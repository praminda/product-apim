...
public class SubscriptionIndividualApi {
    ...
    private com.squareup.okhttp.Call subscriptionsPostCall(Subscription body, String contentType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public Subscription subscriptionsPost(Subscription body, String contentType) throws ApiException {
        ApiResponse<Subscription> resp = subscriptionsPostWithHttpInfo(body, contentType);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Subscription> subscriptionsPostWithHttpInfo(Subscription body, String contentType) throws ApiException {
        com.squareup.okhttp.Call call = subscriptionsPostCall(body, contentType, null, null);
     ...
     */
    public com.squareup.okhttp.Call subscriptionsPostAsync(Subscription body, String contentType, final ApiCallback<Subscription> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = subscriptionsPostCall(body, contentType, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Subscription>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for subscriptionsSubscriptionIdDelete */
    private com.squareup.okhttp.Call subscriptionsSubscriptionIdDeleteCall(String subscriptionId, String ifMatch, String ifUnmodifiedSince, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> subscriptionsSubscriptionIdDeleteWithHttpInfo(String subscriptionId, String ifMatch, String ifUnmodifiedSince) throws ApiException {
        com.squareup.okhttp.Call call = subscriptionsSubscriptionIdDeleteCall(subscriptionId, ifMatch, ifUnmodifiedSince, null, null);
